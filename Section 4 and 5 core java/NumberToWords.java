...
public class NumberToWords {
    public static void numberToWords(int num){
        int lastDigit=0 , rev = reverse(num) , numdig=getDigitCount(num) , revdig=getDigitCount(rev);
         if (num < 0) System.out.println("Invalid Value");
            ...
            while (rev != 0){
             ...
             if (numdig != revdig){
         int digdif = numdig - revdig;
         for (int i=0;i < digdif;i++) System.out.println("Zero");
        }
        }
    }
